...
var HighlightPlayer = Class.create( {
	...
	LoadMovie: function( id )
	{
		...
		if ( $(strTarget) && $(strTarget).tagName == 'DIV' )
		{
			...
			swfobject.embedSWF( "http://cdn2.store.steampowered.com/public/swf/videoPlayer.swf?v=10", strTarget, rgFlashVars['STAGE_WIDTH'], rgFlashVars['STAGE_HEIGHT'], strRequiredVersion, false, rgFlashVars, {wmode: "opaque", allowScriptAccess: "always", allowFullScreen: "true" } );
			if ( $(strTarget) && $(strTarget).tagName == 'DIV' )
			{
	...
	$.fn.videoControls = function( options ) {
		...
		return this.each(function() {
			...
			function setup()
			{
				...
				$('.progress_bar_background',overlay).bind('click', function(e) { progressClick(e, this); });
			...
			function show()
			{
				...
				overlay.show();
				var maxWidth = $('.progress_bar_background', overlay).width();
